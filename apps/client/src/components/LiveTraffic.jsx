...
export default function LiveTraffic() {
        ...
        try {
            ...
            if (data) {
                const formatted = data.map(item => {
                    // PRIORITAS UTAMA: s3 (DANCOK) > slug > click_id (dipotong)
    ...
    useEffect(() => {
        ...
        subscriptionRef.current = supabaseTraffic
            ...
            .on('postgres_changes', { event: 'INSERT', schema: 'public', table: 'clicks' }, payload => {
                ...
                // PRIORITAS REALTIME: s3 (DANCOK) > slug > click_id (dipotong)
    ...
    return (
        <div className="rounded-xl p-4 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 shadow-sm">
