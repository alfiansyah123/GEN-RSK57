                                    ...
                                    <tr key={index} className="bg-white dark:bg-transparent hover:bg-indigo-50/10 dark:hover:bg-indigo-500/5 transition-all">
                                        ...
                                        <td className="px-6 py-4">
                                            {(() => {
                                                ...
                                                if (lowerNet.includes('torazzo')) return <div className="flex items-center gap-1.5"><div className="bg-emerald-500 rounded p-1 text-[10px]">🎯</div><span className="text-[10px] font-bold text-emerald-500">Torazzo</span></div>;
